    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><router-link class="nav-link px-2 link-secondary" to="/overview">Overview</router-link></li>
          <li><router-link class="nav-link px-2 link-secondary" to="/game">Game</router-link></li>
          <li><router-link class="nav-link px-2 link-secondary" to="/friend-list">Friend List</router-link></li>
        </ul>
        ...
        <div class="dropdown text-end">
          ...
          <a @click="toggleDropdown" class="d-block link-body-emphasis text-decoration-none dropdown-toggle">
            <img src="https://avatars.githubusercontent.com/u/99480973?v=4" alt="mdo" class="rounded-circle" width="32" height="32">
          </a>
  ...
  methods: {
    ...
    async fetchUsername() {
      try {
        ...
        const response = await api.get("user/whoami/", { refresh: refreshToken });
