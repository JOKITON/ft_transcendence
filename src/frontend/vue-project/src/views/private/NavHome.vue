      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li class="nav-link px-2 link-secondary">
            <a @click="toggleDropdownAdmin"
              class="d-block link-body-emphasis text-decoration-none dropdown-toggle">Admin</a>
            <div class="dropdown text-end">
              <ul class="dropdown-menu text-small" :class="{ show: isDropdownAdminVisible }">
                <li><router-link class="nav-link px-2 link-secondary" to="/user-list">User List</router-link></li>
                <li>
        ...
        <div class="dropdown text-end">
          <a @click="toggleDropdownSettings" class="d-block link-body-emphasis text-decoration-none dropdown-toggle">
            <img src="https://avatars.githubusercontent.com/u/99480973?v=4" alt="mdo" class="rounded-circle" width="32"
              height="32" />
          </a>
