...
const scorePlayerAI = new Score(numScorePlayerTwo, new Color('white'), new Vector3(2, 5, 0));
...
playerAI = new Player(new Vector3(0.4, 2, 0.5), new Color('blue'), new Vector3(16, 0, 0), '', '', 'AI');
