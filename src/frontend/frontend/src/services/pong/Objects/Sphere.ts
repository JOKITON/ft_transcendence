...
export default class Sphere {
  ...
  public setVelocityX(velocityX: number): void {
    if (velocityX) this.velocity.x = velocityX
  }
  public setVelocityY(velocityY: number): void {
    if (velocityY) this.velocity.y = velocityY
  }
  public setVelocityZ(velocityZ: number): void {
    if (velocityZ) this.velocity.z = velocityZ
  }
  ...
  public randomizeDirection(): void {
    ...
    if (randNum > 0.5) this.velocity.y -= randNum * 0.1
    else this.velocity.y += randNum * 0.1
  }
